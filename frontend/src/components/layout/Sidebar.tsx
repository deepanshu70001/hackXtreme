    ...
    <div className="relative z-20 hidden h-full w-72 flex-col border-r border-white/5 bg-[#080808]/80 backdrop-blur-2xl xl:flex">
      <div className="flex h-full flex-col p-6">
        ...
        >
          ...
          <span className="text-[10px] font-medium text-text-secondary uppercase tracking-widest pl-12 mt-1">Local AI</span>
        </motion.div>
        ...
        <div className="mt-6 border-t border-white/5 pt-6">
          ...
          >
            ...
            <div className="flex flex-col">
              <p className="text-xs font-semibold text-white">Privacy First</p>
